...
const registerCSSInterfaceWithClassicTheme = require('../src/utils/registerCSSInterfaceWithClassicTheme').default;
...
registerCSSInterfaceWithClassicTheme();
...
const outputFilePath = optimizeForProduction ? './lib/css/_datepicker-classic.css' : './css/styles-classic.css';
